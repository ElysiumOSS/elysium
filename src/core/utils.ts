...
export class Logger {
	...
	constructor(context: string, options: LoggerOptions = {}) {
		...
		this.isServerContext = Logger.isServer;
		this.minLevel =
			options.minLevel ??
	...
	public static getLogger(context: string, options?: LoggerOptions): Logger {
		...
		if (!instance) {
			throw new Error(
				`Logger instance for context '${context}' not found after creation.`,
			);
		}
		return instance;
	}
	...
	info(message: string, data?: LogData): void {
		...
		console.log(
			this.colorize(
				this.levelColors.info as ColorKey,
	...
	error(message: string, error?: Error | unknown, data?: LogData): void {
		...
		console.error(
			this.colorize(
				"bold",
				this.colorize(
					this.levelColors.error as ColorKey,
	...
	warn(message: string, data?: LogData): void {
		...
		console.warn(
			this.colorize(
				this.levelColors.warn as ColorKey,
				this.formatLogLevel("warn"),
			) +
				" " +
				this.formatOutput(formattedData),
		);
	...
	debug(message: string, data?: LogData): void {
		...
		console.debug(
			this.colorize(
				this.levelColors.debug as ColorKey,
				this.formatLogLevel("debug"),
			) +
				" " +
				this.formatOutput(formattedData),
		);
	...
	trace(message: string, data?: LogData): void {
		...
		console.debug(
			this.colorize(
				this.levelColors.trace as ColorKey,
				this.formatLogLevel("trace"),
			) +
				" " +
				this.formatOutput(formattedData),
		);
	...
	action(message: string, data?: LogData): void {
		...
		console.log(
			this.colorize(
				this.levelColors.action as ColorKey,
				this.formatLogLevel("action"),
			) +
				" " +
				this.formatOutput(formattedData),
		);
	...
	success(message: string, data?: LogData): void {
		...
		console.log(
			this.colorize(
				this.levelColors.success as ColorKey,
				this.formatLogLevel("success"),
			) +
				" " +
				this.formatOutput(formattedData),
		);
